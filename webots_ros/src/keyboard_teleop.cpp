...
void lidarCallback(const sensor_msgs::PointCloud::ConstPtr &cloud)
{
...
int main(int argc, char **argv) {
  ...
  {
    ros::Subscriber sub_lidar_scan = n.subscribe("/pioneer3at/Sick_LMS_291/point_cloud", 10, lidarCallback);
    LaserPub = n.advertise<sensor_msgs::PointCloud2>("MuliLaserCloud", 1);
    ros::Rate rate(10);
    while (ros::ok())
    {
      ros::spinOnce();
